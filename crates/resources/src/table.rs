...
mod tests {
    ...
    fn status_type_color_returns_different_colors_for_each_status() {
        ...
        // Ready should be success (green) and Failed should be error (red)
    ...
    #[test]
    fn sort_direction_toggle_ascending_to_descending() {
        assert_eq!(SortDirection::Ascending.toggle(), SortDirection::Descending);
    }

    #[test]
    fn sort_direction_toggle_descending_to_ascending() {
    ...
    #[test]
    fn bulk_dialog_equality() {
        assert_eq!(BulkDialog::ConfirmDelete, BulkDialog::ConfirmDelete);
        assert_eq!(BulkDialog::Scale, BulkDialog::Scale);
        assert_eq!(BulkDialog::Label, BulkDialog::Label);
        assert_ne!(BulkDialog::ConfirmDelete, BulkDialog::Scale);
        assert_ne!(BulkDialog::Scale, BulkDialog::Label);
    }
}
