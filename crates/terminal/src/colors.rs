...
pub const DEFAULT_FG: Rgb = Rgb { r: 0x94, g: 0xA3, b: 0xB8 };

/// Default background — matches theme surface_elevated (#0F172A).
pub const DEFAULT_BG: Rgb = Rgb { r: 0x0F, g: 0x17, b: 0x2A };

/// Cursor color — matches theme accent cyan (#22D3EE).
pub const CURSOR_COLOR: Rgb = Rgb { r: 0x22, g: 0xD3, b: 0xEE };
...
fn indexed_color(idx: u8) -> Rgb {
    if idx < 16 {
        ...
        Rgb { r: component(r), g: component(g), b: component(b) }
    } else {
